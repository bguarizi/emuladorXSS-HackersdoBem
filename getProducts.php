<?php
    ...
    if ($nome != '') {
      ...
      echo "<div class='div_product_button'> <a href='./laboratory.php'><button type='button' class='btn btn-outline-secondary product_button'>Voltar à página inicial</button></a> </div>";
      ...
      <span class='visually-hidden'>Next</span>
       ...
       echo "<div id='products'>";
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<a href='commentsProduct.php?id=" . $row["id"] . "'>
            <button type='button' class='btn btn-dark product_button'>Saiba mais</button>
            </a>";
