    ...
    <div class="menu-lateral" id="menu-lateral">
        <div class="dropdown">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img src="../img/levels.png" alt="">Avançado
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                ...
                <button class="dropdown-item" type="button" onclick="window.location.href='../intermediario/intro_interm.php'">Intermediário</button>
            </div>
        </div>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item py-2">
                <a class="nav-link" href="../Trail_avanc.php" style="color:white;">Trilha de Progresso</a>
            </li>

            <li class="nav-item py-2">
                <a class="nav-link" href="../conteudo_teorico/intro_avanc.php" style="color:white;">Introdução</a>
            </li>
            ...
            <ul class="collapse ul-subitem" id="XssRef">
                ...
                <a href="../conteudo_teorico/avanc_intro_refletido1.php">Introdução</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../tutoriais_avancado/lab1-refletido1.php">Laboratório Inspeção</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../questionarios/quiz_refletido_avanc.php">Perguntas</a><br>
                </li>
            </ul>
            ...
            <li class="nav-subitem">
                <a href="../conteudo_teorico/avanc_intro_armazenado1.php">Introdução</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../tutoriais_avancado/lab1-armazenado1.php">Laboratório Keylogger</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../questionarios/quiz_armazenado_avanc.php">Perguntas</a><br>
                </li>
            ...
            <ul class="collapse ul-subitem" id="sanitizaçao">
                <li class="nav-subitem">
                <a href="../conteudo_teorico/avanc_intro_sanitizado1.php">Introdução</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../questionarios/quiz_sanitizacao.php">Perguntas</a><br>
                </li>
                <li class="nav-subitem">
                <a href="../tutoriais_avancado/lab1-sanitizado1.php">Laboratório Sanitização</a><br>
                </li>
            </ul>
        ...
        <div class="progress" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
            <?php echo "<div class='progress-bar bg-success' style='width:".$calculatedPercentageAvanc."%'>".$calculatedPercentageAvanc."%</div>" ?>
        </div>

        <p class="pontuacao">Pontuação: <?php echo $calculatedScoreAvanc; ?> XP</p>
