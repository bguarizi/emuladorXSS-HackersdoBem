...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/avancado-refletido1-pagina8.png">
            </div>
    
    <div class ="container-robot" style="transform: translate(37vw, -8.5vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Após realizar a alteração (1) da conta hackergood para convidado, iremos atualizar (2) o navegador para visualizar os efeitos desta modificação.
            </p>
        </div>
        ...
        <a href="./lab1-refletido7.php" class="btn btn-primary transition-button" draggable="false" id="transition-back">
        &lt;&lt;Retornar  
    </a> 
    <a href="./lab1-refletido9.php" class="btn btn-primary transition-button" draggable="false" id="transition-next">
        Prosseguir&gt;&gt;
    </a> 
        </div>
</div>
