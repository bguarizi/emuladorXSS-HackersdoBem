...
<div style="display: flex; width: 100%;">
    ...
    <div class ="container-robot" style="transform: translate(0vw, 15vw) scale(1.3);">
        <div class="robot-speech"  style="transform: scale(1)">
            <p class="writer central-text" id="balloon-text">
            Por fim, observe que todas as informações digitadas estão sendo armazenadas na página index99.html e, caso fôssemos um hacker malicioso, poderíamos afetar múltiplos usuário com este ataque. Isso nos mostra o quão importante é sabermos nos prevenir, não é mesmo?
            </p>
        </div>
        ...
        <div class="image-container">
            <img src="../img/tutorial/avancado-armazenado1-pagina4.png">
        </div>
