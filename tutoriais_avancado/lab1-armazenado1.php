...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/avancado-armazenado1-pagina1.png">
            </div>
    
    <div class ="container-robot" style="transform: translate(37vw, -8.5vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Está preparado para conhecer um ataque ainda mais interessante dos que os que foram vistos até agora?
            </p>
        </div>
        ...
        <button class="btn btn-primary transition-button" id="transition-back" style="color: white; text-decoration: none;" onclick="window.location.href = '../conteudo_teorico/avanc_intro_armazenado3.php';">
            &lt;&lt;Retornar
        </button>
