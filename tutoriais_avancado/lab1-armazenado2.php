...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/avancado-armazenado1-pagina2.png">
            </div>
    
    <div class ="container-robot" style="transform: translate(50vw, -15vw) scale(1.3);">
        <div class="robot-speech" style="transform: scale(1.1)">
            <p class="writer central-text" id="balloon-text">
            O ataque de Keylogger tem o intuito de roubar todas as informações que são digitadas no teclado de um usuário. Para explorar este ataque de maneira persistente em nossa página, iremos inserir o nosso payload no campo de comentários do site.
            </p>
        </div>
