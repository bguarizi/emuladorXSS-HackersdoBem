...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/refletido2-pagina2.png" alt="">
            </div>
    
    <div class ="container-robot" style="transform: translate(7vw, -58.5vw) scale(1);">
        <div class="robot-speech ">
            <p class="writer central-text" id="balloon-text">
            Desta vez, de forma semelhante ao que fizemos anteriormente, irei inserir o "&lt;script&gt;window.open("./redirecionamento_ref.html", "_self")&lt;/script&gt;" e ao clicar na lupa de busca, seremos encaminhados para uma outra página.            
              </p>
        </div>
  ...
  <div class="container-buttons" style="margin-top: 5vh;">
    <a href="lab2-refletido1.php" draggable = "false" style="color: white; text-decoration: none;">
        <div class="btn btn-primary transition-button" id="transition-back">
            &lt;&lt;Retornar 
        </div>
    </a>
    <a href="lab2-refletido3.php"  draggable = "false" style="color: white; text-decoration: none;">
