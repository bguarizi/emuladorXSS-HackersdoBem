...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/pc1DOM.png">
            </div>
    
    <div class ="container-robot" style="transform: translate(37vw, -8.5vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Parabéns! Falta pouco para você concluir o nível básico do nosso treinamento.
            Fico muito feliz de você ter chegado até aqui. Entendemos diferentes tipos de XSS na prática, agora, vamos para o último?</p>
        </div>
        ...
        <button class="btn btn-primary transition-button" id="transition-back" style="color: white; text-decoration: none;" onclick="window.location.href = '../conteudo_teorico/intro_dom2.php';">
            &lt;&lt;Retornar
        </button>
...
<script>
transformRobotForMenuState(-7, 2);
</script>
</body>
</html>
