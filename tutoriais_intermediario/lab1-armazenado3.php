...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            ...
            <img src="../img/tutorial/intermediario-armazenado1-pagina3.png" alt= "">
            </div>
    <div class ="container-robot" style="transform: translate(34vw, -9vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Após inserir um script, é possível verificar que ele permanece persistente na página e será executado para cada usuário. Agora é a sua vez! Insira o script e explore sua execução.
            </p>
        </div>
        ...
        <a href="./lab1-armazenado2.php"  style="color: white; text-decoration: none; z-index:100;">
...
<script>
var taskNo = 13; //Ainda não definido
var redirPath = "../laboratorio/voting_lab.php?atividade=arm_vote";
let caso = 'EIA';
</script>
