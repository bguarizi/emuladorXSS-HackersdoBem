...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            <div class="image-container">
                <img src="../img/tutorial/intermediario-armazenado1-pagina1.png">
            </div>
    
    <div class ="container-robot" style="transform: translate(43vw, -8.5vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Após entender melhor sobre o XSS Refletido, que tal avançar um pouco mais no XSS Armazenado? 
            </p>
        </div>
        ...
        <button class="btn btn-primary transition-button" id="transition-back" style="color: white; text-decoration: none;" onclick="window.location.href = '../conteudo_teorico/interm_intro_armazenado3.php';">
            &lt;&lt;Retornar
        </button>
