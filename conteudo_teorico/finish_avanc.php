...
<head>
    ...
    <title>Finalização do nível Avançado</title>
</head>
<body>
...
<div class="content" style="margin-right: 0px">
  <div class="central-box" >
    <div class="central-text">
      <div id="first-text">
      <h3>Finalização do Nível Avançado</h3>
                <p>
                    <strong> Parabéns! </strong>
                </p>

                <p>
                    Esta foi uma ótima jornada, muitos aprendizados e desafios foram vistos até aqui.
                </p>
    ...
    <div class ="container-robot" style="">
            <div class="robot-speech">
                    ...
                    Obrigado por ter chegado até aqui junto comigo! Parabéns pelo seu progresso.
                    </p>
                </div>
        ...
        <button class="btn btn-primary transition-button" id="transition-back" style="color: white; text-decoration: none;" onclick="window.location.href = '../laboratorio/lab_sanitizacao.php?atividade=avanc_sanitizado';">
        &#60&#60Retornar
        </button>
        </div>
