...
<head>
    ...
    <title>Finalização do nível Intermediário</title>
</head>
<body>
...
<div class="content" style="margin-right: 0px">
  <div class="central-box" >
    <div class="central-text">
      <div id="first-text">
      <h3>Finalização do Nível Intermediário</h3>
      <p>
                    <strong> Parabéns! </strong>
                </p>

                <p>
                Você concluiu o nível intermediário e deu mais um passo da sua jornada de aprendizado. 
                </p>

                <p>
                Se prepare, que o próximo nível será acompanhado de mais aventuras! 
                </p>
    ...
    <div class ="container-robot" style="">
            <div class="robot-speech">
                    ...
                    Obrigado por ter chegado até aqui junto comigo. Siga para o nível avançado e explore os poderes da sanitização. Até a próxima!
                    </p>
                </div>
        ...
        <button class="btn btn-primary transition-button" id="transition-next" style="color: white; text-decoration: none;" onclick="window.location.href = '../conteudo_teorico/intro_avanc.php';">
            Prosseguir&gt;&gt;
        </button>
        </div>
